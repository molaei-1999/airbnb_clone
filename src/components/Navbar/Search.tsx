  ...
  return (
    <ul
      className="flex justify-center items-center text-[5px]
        ...
        md:ms-[-1rem] lg:ms-[2rem] lg:py-1 lg:px-[6px] lg:text-base xl:ms-[11.5rem]"
    >
      <li
        className="capitalize cursor-pointer border-r px-3 border-stone-400 lg:px-5
      ...
      <AddGuestsComp>
        <li
          className="capitalize cursor-pointer flex items-center justify-center px-3 lg:px-5
          text-sm xl:text-base"
        >
          add guests
